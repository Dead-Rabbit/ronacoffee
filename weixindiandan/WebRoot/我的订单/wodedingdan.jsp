 ...
 %>					
	...
	<!--footer_bar-->
	  <div class="footer_bar3">
		<ul>
			<li style="width: 50%;text-align: center;"><a href="../testGetInMenu"><span class="tab_nav31" style="padding: 0;">我要点菜</span></a></li>

			<li style="width: 50%;text-align: center;"><a href="./wodedingdan.jsp?weichatId=<%=weichatId %>" class="current"><span class="tab_nav33"  style="padding: 0;">我的订单</span></a></li>
		</ul>
	  </div>
	</footer>
